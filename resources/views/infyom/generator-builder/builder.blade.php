...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/custom_gui_builder.css') }}" rel="stylesheet"/>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pluginjs/validate.js') }}"></script>
    <script src="{{ asset('admin-assets/js/pages/custom_gui_builder.js') }}"></script>
    <script>
