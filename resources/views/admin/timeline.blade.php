...
@section('header_styles')    
	...
	<link href="{{ asset('admin-assets/css/pages/timeline.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin-assets/css/pages/timeline2.css') }}" rel="stylesheet" />
                                    ...
                                    <div class="col-12">
                                        ...
                                        <li>
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class="fa fa-record invert" rel="tooltip" title="7Hours ago via Facebook"></i>
                                                </a>
                                            </div>
                                        ...
                                        <li class="timeline2-inverted">
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class="fa fa-dot-circle" rel="tooltip" title="2 Days ago via Facebook"></i>
                                                </a>
                                            </div>
                                            <div class="timeline2-panel">
                                                <div class="timeline2-heading">
                                                    <img data-src="holder.js/580x160/#00BC8C:#fff" class='img-fluid' alt="image">
                                                </div>
                                                <div class="timeline2-body">
                                        ...
                                        <li>
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class=" far fa dot-circle" rel="tooltip" title="5 Days ago via Facebook"></i>
                                                </a>
                                            </div>
                                            <div class="timeline2-panel">
                                                <div class="timeline2-heading">
                                                    <img data-src="holder.js/580x160/#418bca:#fff" class='img-fluid' alt="image">
                                                </div>
                                                <div class="timeline2-body">
                                        ...
                                        <li class="timeline2-inverted">
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class="fa fa-record invert" rel="tooltip" title="6 Days ago via Facebook"></i>
                                                </a>
                                            </div>
                                            <div class="timeline2-panel">
                                                <div class="timeline2-body">
                                        ...
                                        <li>
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class="fa fa dot-circle" rel="tooltip" title="7 Days ago via Facebook"></i>
                                                </a>
                                            </div>
                                            <div class="timeline2-panel">
                                                <div class="timeline2-heading">
                                                    <img data-src="holder.js/580x160/#5bc0de:#fff" class='img-fluid' alt="image">
                                                </div>
                                                <div class="timeline2-body">
                                        ...
                                        <li class="timeline2-inverted">
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class="fa fa-record invert" rel="tooltip" title="9 Days ago via Facebook"></i>
                                                </a>
                                            </div>
                                            <div class="timeline2-panel">
                                                <div class="timeline2-heading">
                                        ...
                                        <li>
                                            <div class="timeline2-badge">
                                                <a>
                                                    <i class="fa fa-record invert" rel="tooltip" title="11 Days ago via Facebook"></i>
                                                </a>
                                            </div>
                                            <div class="timeline2-panel">
                                                <div class="timeline2-body">
