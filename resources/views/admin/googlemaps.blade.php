...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/googlemaps_custom.css') }}" rel="stylesheet">
@stop
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('admin-assets/js/pages/custommaps.js') }}"></script>
@stop
