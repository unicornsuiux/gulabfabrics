...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/iCheck/css/alls.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('admin-assets/css/pages/form_layouts.css') }}" rel="stylesheet" type="text/css"/>
@stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/form_layouts.js') }}" type="text/javascript"></script>
