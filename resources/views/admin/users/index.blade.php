...
<link href="{{ asset('css/admin/pages/tables.css') }}" rel="stylesheet" type="text/css" />
@stop
    ...
    <div class="row">
        ...
        <div class="card ">
            <div class="card-header bg-primary text-white">
                ...
                <a href="{{ URL('admin/users/create') }}" class="float-right btn btn-light">
                                <i class="fa fa-plus fa-fw"></i>Create New User</a>
            </div>
            <div class="card-body">
