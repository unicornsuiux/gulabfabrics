...
<link href="{{ asset('css/admin/pages/wizard.css') }}" rel="stylesheet">
@stop
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <p class="text-danger"><strong>Be careful with role selection, if you give admin
                                    access.. they can access all admin functionalities.</strong></p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="activate" name="activate" type="checkbox"
                                            ...
                                            checked="checked" @endif checked="checked" disabled>
...
<script src="{{ asset('js/admin/pages/edituser.js') }}"></script>
<script>
