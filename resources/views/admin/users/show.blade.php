...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/user_profile.css') }}" rel="stylesheet"/>
@stop
                                        ...
                                        <div class="col-md-4">
                                            <div class="img-file">
                                                ...
                                                @elseif($user->gender === "male")
                                                    <img src="{{ asset('admin-assets/images/authors/avatar3.png') }}" alt="..."
                                                         class="img-fluid"/>
                                                @elseif($user->gender === "female")
                                                    <img src="{{ asset('admin-assets/images/authors/avatar5.png') }}" alt="..."
                                                         class="img-fluid"/>
                                                @else
                                                    <img src="{{ asset('admin-assets/images/authors/no_avatar.jpg') }}" alt="..."
                                                         class="img-fluid"/>
                                                @endif
                                            </div>
                                        </div>
