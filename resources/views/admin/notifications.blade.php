...
<link href="{{ asset('vendors/noty/css/noty.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin-assets/css/pages/fluid.css') }}"  rel="stylesheet"/>
    <link href="{{ asset('admin-assets/css/pages/toastr.css') }}" rel="stylesheet" />
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/noty/js/noty.js') }}" ></script>
<script src="{{ asset('admin-assets/js/pages/jquery.noty.packaged.min.js') }}" ></script>
<script src="{{ asset('admin-assets/js/pages/noty_script.js') }}" ></script>
