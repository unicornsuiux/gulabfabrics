...
<script src="{{ asset('admin-assets/js/pages/custom_sweetalert.js') }}" type="text/javascript"></script>
<script>
var image="{{ asset('admin-assets/images/c1.jpg') }}";
var image1="{{ asset('admin-assets/images/c2.jpg') }}";
