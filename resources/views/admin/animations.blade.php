...
<link href="{{ asset('admin-assets/css/pages/transitions.css') }}" rel="stylesheet" />
...
<!--panel js-->
<script src="{{ asset('admin-assets/js/pages/transitions.js') }}" type="text/javascript"></script>
