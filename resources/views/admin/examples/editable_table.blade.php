...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin-assets/css/pages/tables.css') }}"/>
@stop
...
@section('footer_scripts')
    ...
    {{--<script type="text/javascript" src="{{ asset('admin-assets/js/pages/table-editable.js') }}" ></script>--}}
    <script src="{{ asset('vendors/sweetalert/js/sweetalert2.js') }}" type="text/javascript"></script>
{{--    <script src="{{ asset('admin-assets/js/pages/sweetalert.dev.js') }}" type="text/javascript"></script>--}}
