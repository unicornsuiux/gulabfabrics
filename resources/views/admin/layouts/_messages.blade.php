                    ...
                    <li class="unread message dropdown-item">
                        <a href="{{ URL::to('admin/emails/'.$notification->id ) }}" class="message"> <i class="float-right" data-toggle="tooltip"
                            ...
                            @elseif(Sentinel::getUser()->gender === "male")
                                <img src="{{ asset('admin-assets/images/authors/avatar3.png') }}" alt="img" class="img-fluid rounded-circle message-image"/>
                            @elseif(Sentinel::getUser()->gender === "female")
                                <img src="{{ asset('admin-assets/images/authors/avatar5.png') }}" alt="img" class="img-fluid rounded-circle message-image"/>

                            @else
                                <img src="{{ asset('admin-assets/images/authors/no_avatar.jpg') }}" alt="img" class="img-fluid rounded-circle message-image"/>
                            @endif
