...
<link rel="stylesheet" href="{{ asset('admin-assets/css/pages/dashboard2.css') }}" />
                ...
                <div class="card-body nopadmar users">
                    ...
                    <div class="media">
                        <div>
                            ...
                            @else
                            <img src="{{ asset('admin-assets/images/authors/no_avatar.jpg') }}" class="media-object rounded-circle">
                            @endif
                        </div>
