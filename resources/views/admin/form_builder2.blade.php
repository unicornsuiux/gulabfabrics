...
@section('header_styles')
    <link href="{{ asset('admin-assets/css/pages/formbuilder1.css') }}"  rel="stylesheet"/>
    <link href="{{ asset('admin-assets/css/pages/form_builder2.css') }}"  rel="stylesheet"/>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/form_builder2.js') }}" ></script>
<script src="{{ asset('admin-assets/js/pages/jquery-ui.min.js') }}" ></script>
