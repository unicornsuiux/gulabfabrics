...
<head>
    ...
    <!-- page level css -->
    <link href="{{ asset('admin-assets/css/pages/lockscreen.css') }}" rel="stylesheet" />
...
<body>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <div>
                ...
                <img src="{{ asset('admin-assets/images/authors/avatar3.png') }}" alt="img" class="img-circle img-responsive " />

                @elseif($user->gender === "female")
                <img src="{{ asset('admin-assets/images/authors/avatar5.png') }}" alt="img" class="img-circle img-responsive " />
    ...
    {{--<script src="{{ asset('admin-assets/js/pages/lockscreen.js') }}"></script>--}}
    <script>
