...
<link href="{{ asset('admin-assets/css/pages/advancedmaps_custom.css') }}" rel="stylesheet">
...
<script type="text/javascript" src="{{ asset('admin-assets/js/pages/adv_maps.js') }}"></script>
