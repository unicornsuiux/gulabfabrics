...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/tagsinput.css') }}" rel="stylesheet" />
@stop
                    ...
                    <div class="example example_multivalue">
                        ...
                        <div class="bs-example">
                            <select multiple data-role="tagsinput">
                                <option value="Amsterdam" class="bg-primary">Amsterdam</option>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/Categorizing_tags.js') }}"  type="text/javascript"></script>
@stop
