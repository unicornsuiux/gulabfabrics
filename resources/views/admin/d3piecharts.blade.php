...
@section('header_styles')
    <link href="{{ asset('admin-assets/css/pages/piecharts.css') }}" rel="stylesheet" type="text/css" />
...
@section('footer_scripts')
    ...
    <script language="javascript" type="text/javascript" src="{{ asset('admin-assets/js/pages/custompiecharts.js') }}" ></script>
