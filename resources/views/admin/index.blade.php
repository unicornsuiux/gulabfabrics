...
<link href="{{ asset('admin-assets/css/pages/calendar_custom.css') }}" rel="stylesheet" type="text/css" />
<link rel="stylesheet" media="all" href="{{ asset('vendors/bower-jvectormap/css/jquery-jvectormap-1.2.2.css') }}" />
<link rel="stylesheet" href="{{ asset('vendors/animate/animate.min.css') }}">
<link rel="stylesheet" href="{{ asset('admin-assets/css/pages/only_dashboard.css') }}" />
...
<section class="content indexpage d-none pr-3 pl-3">
    <div class="row">
...
<!--  todolist-->
<!-- <script src="{{ asset('admin-assets/js/pages/todolist.js') }}"></script> -->
<script src="{{ asset('/js/admin/pages/dashboard.js') }}" type="text/javascript"></script>


<!--//jquery-ui-->

{{--<script src="{{ asset('admin-assets/js/pages/jquery-ui.min.js') }}" type="text/javascript"></script>--}}
