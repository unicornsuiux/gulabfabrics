...
@section('header_styles')
    <link href="{{ asset('admin-assets/css/pages/invoice.css') }}" rel="stylesheet" type="text/css"/>
@stop
...
@section('footer_scripts')
    ...
    <script  src="{{ asset('admin-assets/js/pages/invoice.js') }}"  type="text/javascript"></script>
