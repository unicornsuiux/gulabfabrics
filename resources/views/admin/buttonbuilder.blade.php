...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/buttonbuilder2.css') }}" rel="stylesheet"/>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/scripts.min.js') }}"  type="text/javascript"></script>
    ...
    <script src="{{ asset('admin-assets/js/pages/buttonbuilder.js') }}"  type="text/javascript"></script>
