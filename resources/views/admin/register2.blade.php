...
<head>
    <title>Register | Gulab Fabrics Admin</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- global level css -->
    <link href="{{ asset('css/bootstrap.min.css') }}" rel="stylesheet" />
    <!-- end of global level css -->
    <!-- page level css -->
    <link href="{{ asset('admin-assets/css/pages/login2.css') }}" rel="stylesheet" />
...
<script src="{{ asset('admin-assets/js/pages/register2.js') }}" type="text/javascript"></script>
