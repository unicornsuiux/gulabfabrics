...
@section('title')
   Radio And Checkbox
    ...
    @section('header_styles')
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('admin-assets/css/pages/formelements.css') }}"/>
...
<div class="row">
    ...
    <script language="javascript" type="text/javascript" src="{{ asset('admin-assets/js/pages/radio_checkbox.js') }}"></script>
