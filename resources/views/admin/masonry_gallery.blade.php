...
@section('header_styles')    
	...
	<link href="{{ asset('admin-assets/css/pages/animated-masonry-gallery.css') }}" rel="stylesheet" type="text/css" />
...
@section('footer_scripts')
    ...
    <!--<script type="text/javascript" src="{{ asset('admin-assets/js/pages/jquery.isotope.min.js') }}" ></script>-->
<script src="https://unpkg.com/isotope-layout@3.0.5/dist/isotope.pkgd.min.js"></script>
    <script type="text/javascript" src="{{ asset('admin-assets/js/pages/animated-masonry-gallery.js') }}" ></script>
