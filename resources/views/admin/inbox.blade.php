...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/alertmessage.css') }}" rel="stylesheet" />
                                        ...
                                        <th colspan="6">
                                            <div class="row">
                                                <div class="col-md-8 col-lg-9 col-12">
                                                    <div class="btn-group float-left table-bordered paddingtopbottom_5px paddingrightleft_10">
                                                    ...
                                                    <div class="btn-group float-left table-bordered paddingtopbottom_5px paddingrightleft_10 margin_left">
                                ...
                                <tbody>
                                    <tr data-messageid="1" class="unread">
                                        ...
                                        <td style="width:13%;" class="view-message text-right">
                                            <a href="{{ URL::to('admin/view_mail') }}">6:30 PM</a>
                                        </td>
                                    </tr>
                                    <tr data-messageid="2" class="unread">
                                        ...
                                        <td class="view-message hidden-xs">
                                            <a href="{{ URL::to('admin/view_mail') }}">
                                                <img data-src="holder.js/25x25/#000:#fff" class="rounded-circle img-fuid float-left" alt="Image">Marin</a>
                                        </td>
                                    ...
                                    <tr data-messageid="4">
                                        ...
                                        <td class="view-message d-none d-sm-block">
                                            <a href="{{ URL::to('admin/view_mail') }}">
                                    ...
                                    <tr data-messageid="12">
                                        ...
                                        <td class="hidden-xs">
                                            <span class="view-message d-none d-sm-block">
                                                <a href="{{ URL::to('admin/view_mail') }}">
