...
@section('header_styles')
	...
	<link href="{{ asset('admin-assets/css/pages/tables.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet box bg-secondary text-white mb-4">
                            ...
                            <div class="portlet-body bg-white text-dark p-2">
                        ...
                        <div class="portlet box bg-warning text-white mb-4">
                            ...
                            <div class="portlet-body bg-white text-dark p-2">
                                <div class="table-responsive">
                                <table class="table table-bordered example basic_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Header 1</th>
                        ...
                        <div class="portlet box bg-info text-white mb-4">
                            ...
                            <div class="portlet-body bg-white text-dark p-2">
                                <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example basic_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Header 1</th>
                        ...
                        <div class="portlet box bg-danger text-white mb-4">
                            ...
                            <div class="portlet-body bg-white text-dark p-2">
                                <div class="table-scrollable table-responsive-lg" >
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/table-responsive.js') }}"></script>
@stop
