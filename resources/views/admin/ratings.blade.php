...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/custom_rating.css') }}" rel="stylesheet" type="text/css"/>
@stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/custom_rating.js') }}" type="text/javascript"></script>
