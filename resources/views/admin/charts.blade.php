...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('admin-assets/css/pages/flot.css') }}" />
...
@section('footer_scripts')
    ...
    <script language="javascript" type="text/javascript" src="{{ asset('admin-assets/js/pages/customcharts.js') }}" ></script>
