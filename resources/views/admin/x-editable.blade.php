...
@section('header_styles')
        ...
        <link href="{{ asset('admin-assets/css/pages/inlinedit.css') }}" rel="stylesheet" />
                ...
                <div class="card-header buttons bg-info">
                    ...
                    <div class="col-md-6 col-lg-6 col-12 text-right">
                        <form method="get" id="frm" class="form-inline-block" action="#">
                            ...
                            <button type="submit" class="btn btn-raised btn-primary btn-sm btn_refresh">Refresh</button>
                        </form>
                    </div>
                </div>
                </div>
...
@section('footer_scripts')
    ...
    <script src="{{asset('admin-assets/js/pages/xeditable-bs4.js')}}"></script>
    ...
    <script src="{{ asset('admin-assets/js/pages/demo-mock.js') }}" ></script>
    <script src="{{ asset('admin-assets/js/pages/demo.js') }}" ></script>
