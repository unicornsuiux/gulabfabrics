...
@section('header_styles')    
	...
	<link href="{{ asset('admin-assets/css/pages/sparklinecharts.css') }}" rel="stylesheet" type="text/css" />
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/sparklinecharts/jquery.sparkline.js') }}"  type="text/javascript"></script>
    <script  src="{{ asset('admin-assets/js/pages/sparkline.js') }}"  type="text/javascript"></script>
