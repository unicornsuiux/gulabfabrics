...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/accordionformwizard.css') }}" rel="stylesheet" />
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/accordionformwizard.js') }}"  type="text/javascript"></script>
    <script>
