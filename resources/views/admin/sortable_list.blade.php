...
@section('header_styles')
    <link href="{{ asset('admin-assets/css/pages/sortable_list.css')}}" rel="stylesheet">
                    ...
                    <div id="multi">
                        <div class="layer tile" data-force="30">
                            ...
                            <div class="tile__list">
                                <img src="{{ asset('admin-assets/images/authors/avatar.jpg') }}"/>
                                <img src="{{ asset('admin-assets/images/authors/avatar1.jpg') }}"/>
                                <img src="{{ asset('admin-assets/images/authors/avatar2.jpg') }}"/>
                                <img src="{{ asset('admin-assets/images/authors/avatar3.jpg') }}"/>
                            </div>
                        </div>
                        <div class="layer tile" data-force="25">
                            <div class="tile__name">Group B</div>
                            <div class="tile__list">
                                <img src="{{ asset('admin-assets/images/authors/avatar4.jpg') }}"/>
                                <img src="{{ asset('admin-assets/images/authors/avatar5.jpg') }}"/>
                                <img src="{{ asset('admin-assets/images/authors/avatar6.jpg') }}"/>
                            </div>
                        </div>
                        <div class="layer tile" data-force="20">
                            <div class="tile__name">Group C</div>
                            <div class="tile__list">
                                <img src="{{ asset('admin-assets/images/authors/avatar7.jpg') }}"/>
                                <img src="{{ asset('admin-assets/images/authors/avatar.jpg') }}"/>
                            </div>
                        </div>
                    </div>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/sortable_list.js') }}" type="text/javascript"></script>
