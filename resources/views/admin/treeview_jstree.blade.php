...
<link href="{{ asset('admin-assets/css/pages/bootstrap-treeview.min.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('admin-assets/css/pages/treeview_jstree.css') }}" rel="stylesheet" type="text/css"/>
...
<script src="{{ asset('admin-assets/js/pages/bootstrap-treeview.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('vendors/iCheck/js/icheck.js') }}" type="text/javascript"></script>
<script src="{{ asset('admin-assets/js/pages/treeview_jstree.js') }}" type="text/javascript"></script>
