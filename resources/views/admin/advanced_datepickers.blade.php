...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/flatpickr/css/flatpickr.min.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('admin-assets/css/pages/adv_date_pickers.css') }}" rel="stylesheet" type="text/css"/>
@stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/custom_datepicker.js') }}" type="text/javascript"></script>
