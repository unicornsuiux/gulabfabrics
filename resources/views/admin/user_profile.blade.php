...
@section('header_styles')
    ...
    <link href="{{ asset('admin-assets/css/pages/user_profile.css') }}" rel="stylesheet" type="text/css"/>
    <style>
                                    ...
                                    <div class="text-center">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail ">
                                                {{--<img src="{{ asset('admin-assets/images/authors/avatar3.jpg') }}" data-src="holder.js/366x218/#fff:#000" class="img-fluid" width="366px" height="218px" />--}}
                                                @if(Sentinel::getUser()->pic)
                                                    <img src="{!! url('/').'/uploads/users/'.Sentinel::getUser()->pic !!}" alt="img"
                                                         class="img-fluid " width="366px" height="218px"/>

                                                @elseif(Sentinel::getUser()->gender === "male")
                                                    <img src="{{ asset('admin-assets/images/authors/avatar3.png') }}" alt="img"
                                                         class="img-fluid " width="366px" height="218px"/>

                                                @elseif(Sentinel::getUser()->gender === "female")
                                                    <img src="{{ asset('admin-assets/images/authors/avatar5.png') }}" alt="img"
                                                         class="img-fluid " width="366px" height="218px"/>
                                                @else
                                                    <img src="{{ asset('admin-assets/images/authors/no_avatar.jpg') }}" alt="img"
                                                         class="img-fluid" width="366px" height="218px"/>
                                                @endif
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" class="thumbnail img-fluid" src="{{ asset('admin-assets/images/authors/avatar.jpg') }}" alt=""></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('admin-assets/images/authors/avatar3.jpg') }}" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('admin-assets/images/authors/avatar7.jpg') }}" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('admin-assets/images/authors/avatar5.jpg') }}" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('admin-assets/images/authors/avatar4.jpg') }}" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('admin-assets/images/authors/avatar2.jpg') }}" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('admin-assets/images/authors/avatar.jpg') }}" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" class="thumbnail img-fluid" src="{{ asset('admin-assets/images/authors/avatar1.jpg') }}" alt=""></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                        ...
                                        <div class="activity">
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('admin-assets/images/authors/avatar.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle img-fluid mr-3" src="{{ asset('admin-assets/images/authors/avatar1.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="float-left" href="#">
                                                            <img class="media-object thumbnail mr-3" src="{{ asset('admin-assets/images/authors/avatar2.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('admin-assets/images/authors/avatar3.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('admin-assets/images/authors/avatar4.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <ul class="uploadphoto-list">
                                                        <li>
                                                            <a href="{{ asset('admin-assets/images/authors/avatar2.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('admin-assets/images/authors/avatar2.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ asset('admin-assets/images/authors/avatar3.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('admin-assets/images/authors/avatar3.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ asset('admin-assets/images/authors/avatar.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('admin-assets/images/authors/avatar.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('admin-assets/images/authors/avatar7.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('admin-assets/images/authors/avatar2.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    <strong>Lenny</strong>
                                                    posted a new note.
                                                    <br>
                                            ...
                                            <div class="imgs-profile media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="float-left" href="#">
                                                            <img class="media-object thumbnail mr-3" src="{{ asset('admin-assets/images/authors/avatar4.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="mb20"></div>
                                                    <a href="{{ asset('admin-assets/images/authors/avatar.jpg') }}" data-rel="prettyPhoto" class="img-single">
                                                        <img src="{{ asset('admin-assets/images/authors/avatar.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                </div>
                                            </div>
                                            <!-- media -->
...
@section('footer_scripts')
    ...
    <script src="{{ asset('admin-assets/js/pages/user_profile.js') }}"  type="text/javascript"></script>
