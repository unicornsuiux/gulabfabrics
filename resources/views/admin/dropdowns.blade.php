...
<link href="{{ asset('admin-assets/css/pages/formelements.css') }}" rel="stylesheet"/>
@stop
...
<script language="javascript" type="text/javascript" src="{{ asset('admin-assets/js/pages/custom_elements.js') }}"></script>
