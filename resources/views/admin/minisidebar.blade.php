...
@section('header_styles')
    ...
    <link rel="stylesheet" href="{{ asset('admin-assets/css/pages/news.css') }}"/>
    <link rel="stylesheet" href="{{ asset('admin-assets/css/pages/minisidebar.css') }}"/>
...
@section('content')
    ...
    <section class="content pr-3 pl-3">
        <!--main content-->
        <div class="row">
            <div class="col-md-12 col-lg-12 col-12 news-page">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img data-src="holder.js/1900x278/#00bc8c:#fff" class="img-fluid" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img data-src="holder.js/1900x278/#5bc0de:#fff" class="img-fluid" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img data-src="holder.js/1900x278/#00BC8C:#fff" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#EF6F6C:#fff" alt="">The
                        ...
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#418bca:#fff" alt="">Su
                        ...
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#A9B6BC:#fff" alt="">COMMERCE
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-3">
                        <div class="news-blocks">
                            <img data-src="holder.js/2000x203/#5bc0de:#fff" class="img-fluid" alt="image"/>
                        ...
                        <div class="news-blocks">
                            <img data-src="holder.js/2000x203/#418bca:#fff" class="img-fluid" alt="image">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-3">
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#00bc8c:#fff" alt="">MINNEAPOLIS
                        ...
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#67cc5df:#fff" alt="">Plenty
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-3">
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#00BC8C:#fff" alt="">Egypt
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-3">
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-right" data-src="holder.js/70x70/#A9B6BC:#fff" alt="">The
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="news-blocks">
                                    ...
                                    <p>
                                        <img class="news-block-img float-right" data-src="holder.js/70x70/#418bca:#fff"
