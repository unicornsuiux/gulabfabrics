...
@section('header_styles')    
    ...
    <link rel="stylesheet" href="{{ asset('admin-assets/css/pages/blog.css') }}" />
                ...
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-full-width-right">
                        ...
                        <div class="the-box no-border blog-detail-content">
                            <p>
                                <span class="label-danger">July 11, 2014 @05:10:45 PM</span>
                            </p>
                        ...
                        <div class="the-box  no-border no-margin text-center more-padding">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <p>
                                        <a href="#fakelink">
                                            <img data-src="holder.js/22x22/#00bc8c:#fff" class="img-fluid rounded-circle" alt="riot">
                                        </a>
                                    </p>
                                </div>
                                <!-- /.col-xs-3 -->
                                ...
                                <div class="accordion">
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" href="#accordion_example_markup" style="font-size:14px;">Show code</a>
                                        </div>
                        ...
                        <div class="the-box no-border no-margin more-padding">
                            ...
                            <div class="tabbable tabbable-custom">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a data-toggle="tab" href="#tab_1_1" class="nav-link active">Section 1</a>
                                    </li>
                                    <li>
                                        <a data-toggle="tab" href="#tab_1_2" class="nav-link">Section 2</a>
                                    </li>
                                </ul>
