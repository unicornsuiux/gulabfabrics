...
@section('header_styles')    
    ...
    <link href="{{ asset('admin-assets/css/pages/alertmessage.css') }}" rel="stylesheet"  type="text/css"/>
@stop
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('admin-assets/js/pages/general.js') }}" ></script>
