...
@section('header_styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('admin-assets/css/pages/log_viewer.css') }}">
@stop
@section('content')
                            ...
                            {{--<div class="card card-default">--}}
                                ...
                                {{--<div class="card-footer">--}}
                                    ...
                                    {{--@if (request()->has('query'))--}}
                                                        {{--<a href="{{ route('log-viewer::logs.show', [$log->date]) }}" class="btn btn-secondary"><span class="glyphicon glyphicon-remove"></span></a>--}}
                                                    {{--@endif--}}
